...
public class EliminarP_201404134 extends JDialog {
	...
	public EliminarP_201404134(Frame parent) {
		super(parent, true);
...
//		this.setDefaultCloseOperation(EXIT_ON_CLOSE);
		...
		eliminarL = new JLabel("Código de producto que se quiere eliminar");
		...
		JButton generar = new JButton("Eliminar Producto");
