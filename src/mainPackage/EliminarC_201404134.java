...
public class EliminarC_201404134 extends JDialog{
	...
	public EliminarC_201404134(Frame parent) {
		super(parent, true);
...
//		this.setDefaultCloseOperation(EXIT_ON_CLOSE);
		...
		eliminarL = new JLabel("Código del cliente que se quiere eliminar");
		...
		JButton generar = new JButton("Eliminar Cliente");
